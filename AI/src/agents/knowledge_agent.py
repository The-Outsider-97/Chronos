...
try:
    ...
    AutoTokenizer = None
    print("Warning: transformers not found. Knowledge capabilities will be limited.")

try:
    from sentence_transformers import SentenceTransformer
except ImportError:
    SentenceTransformer = None
    print("Warning: sentence_transformers not found. Knowledge capabilities will be limited.")

try:
    import pandas as pd
except ImportError:
    pd = None
    print("Warning: pandas not found. Knowledge capabilities will be limited.")
